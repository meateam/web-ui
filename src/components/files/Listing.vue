<template>
  ...
  <div v-else id="listing" :class="user.viewMode" @dragenter="dragEnter" @dragend="dragEnd">
    <div>
  ...
  methods: {
    ...
    uploadInput(event) {
      this.checkConflict(
        ...
        this.req.items,
        this.$store.getters.currentFolder.id
      );
    ...
    isEditOnlineAvailvle: function (file) {
      return canEditOnline(file.type);
    },
    editOnline: function (file) {
